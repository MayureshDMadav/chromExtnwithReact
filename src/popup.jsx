...
const background = () => {
  try {
          ...
          try {
            ...
            if (jsonResponse) {
              ...
              fetch(url, requestOptions)
                ...
                .catch((error) => alert("App Creation Failed please retry once again !!!"));
            }
          } catch (e) {
            console.log(e);
          }
    ...
    clickOnDelay("button[type='button']", 71000, "Reveal token once");
    fetChingCredentials("input[type]", 76000);
  } catch (e) {
    console.log(e);
